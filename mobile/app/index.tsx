...
const discovery = {
  ...
  revocationEndpoint: 'https://github.com/settings/connections/applications/f98649466619e9a175af',
}
...
export default function App() {
  ...
  return (
    ...
    > 
      ...
      <Text className="text-center font-body text-sm leading-relaxed text-gray-200">Feito com 💚 no NLW da RocketSeat por Diogo Santoro</Text>
